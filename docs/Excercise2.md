...
| :---------------------------------------- | :------------------------------------------ |
| `Method`                                  | PUT                                       |
| `Endpoint URL`                            | https://69ee77ae9163f839f892c3d6.mockapi.io/api/cars |
| `Header`                           	    | Content-Type                                |
...
- Select **'Actions'** and click **'Add Action'**.

![Nav](./assets/t2s1ap1a1.png){ width="600" }

- In **Add Action** pane select **Fulfillment**

![Nav](./assets/t2s1ap1a.png){ width="300" }

- Create a New Action page will appear. Provide an 'Action Name' (use carordercreate).
...
![Nav](./assets/t2s1ap1b.png){ width="600" }
...
![Nav](./assets/t2s1ap4a.png){ width="600" }
![Nav](./assets/t2s1ap5a5.png){ width="1000" }
...
- You can also access the datastore where these orders are stored and updated by entering the following URL into your browser:
   ...
   [Car Orders](https://69ee77ae9163f839f892c3d6.mockapi.io/api/cars "download")

![Nav](./assets/t2s3ap3a.png){ width="500" }
